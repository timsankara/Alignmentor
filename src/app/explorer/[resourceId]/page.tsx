...
const Tooltip: React.FC<TooltipProps> = ({ x, y, onComment, onHighlight, onCopy, onSearch, onTranslate, onAskQuestion }) => (
  ...
  >
    <div className="grid grid-cols-3 gap-2">
      <TooltipButton icon={<MessageCircle size={16} className='text-black' />} label="Comment" onClick={onComment} />
      <TooltipButton icon={<Highlighter size={16} className='text-black' />} label="Highlight" onClick={onHighlight} />
      <TooltipButton icon={<Copy size={16} className='text-black' />} label="Copy" onClick={onCopy} />
      <TooltipButton icon={<Globe size={16} className='text-black' />} label="Search" onClick={onSearch} />
      <TooltipButton icon={<Languages size={16} className='text-black' />} label="Translate" onClick={onTranslate} />
      <TooltipButton icon={<HelpCircle size={16} className='text-black' />} label="Ask" onClick={onAskQuestion} />
    </div>
  </div>
);
